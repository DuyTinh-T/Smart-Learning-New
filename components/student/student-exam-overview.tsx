...
export function StudentExamOverview({ roomCode }: ExamOverviewProps) {
  ...
  const fetchOverview = async () => {
    try {
      ...
      const response = await fetch(`/api/student/exam-overview/${roomCode}`, {
        headers: {
  ...
  if (!room) {
    return (
      <div className="text-center p-8">
        <h2 className="text-xl font-semibold mb-2">Overview not available</h2>
        <p className="text-muted-foreground mb-4">
          Unable to load exam overview.
        </p>
